...
public class TransferenciaTest {
    ...
    void teste1() {
        try {
            transf.processar(null, contaDebito, contaCredito);
    ...
    void teste2() {
        try {
            transf.processar(vinte, null, contaCredito);
    ...
    void teste3() {
        try {
            transf.processar(vinte, contaDebito, null);
    ...
    void teste4() {
        try {
            transf.processar(vinte, contaDebito, contaCredito);
